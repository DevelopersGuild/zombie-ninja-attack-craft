...
public class GameManager : MonoBehaviour
{
    ...
    // Key pickup methods
    public static void setKeys(int keySet)
    {
        Keys = keySet;
    }

    public static void addKeys(int added)
    {
        Keys += added;
    }

    public static void subtractKeys(int substract)
    {
        Keys -= substract;
    }

    public static int getBossKeys()
    {
        return BossKeys;
    }

    // Key pickup methods
    public static void setBossKeys(int keySet)
    {
        BossKeys = keySet;
    }

    public static void addBossKeys(int added)
    {
        BossKeys += added;
    }

    public static void subtractBossKeys(int substract)
    {
        BossKeys -= substract;
    }
