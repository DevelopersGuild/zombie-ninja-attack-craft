...
namespace AssemblyCSharp
{
    ...
    public class LightningBoss : MonoBehaviour
    {
        ...
        private double shot_CD, charge_CD, overload_CD, field_CD, speed_CD, thunder_CD, cooldown_CD, bolt_CD, lightning_CD, more;
            ...
            rnd = new System.Random();
                ...
                if (isAgro)
                {
                    ...
                    if (cooldown_CD > 1.5)
                    {
                        ...
                        else if (field_CD > 20 - cd_Reduction)
                        {
                            //shoot first chain
                            //animation
                            //shoot second chain
                        ...
                        else if (charge_CD > 20 + cd_Reduction)
                        {
                            //animation
                            //charge
                            //stun on collision (onCollision2D if isCharging stunned = true)
                        }
                        else
                        {
